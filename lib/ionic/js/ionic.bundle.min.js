...
! function() {
    ...
    window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.2.4",
        function(e) {
    ...
    function() {
        ...
        var t, n = function(e, r, a, o) {
            ...
            if (y.params = r, y.originalParams = _, y.classNames = [], "undefined" != typeof t && "undefined" != typeof i && (t = i), ("undefined" != typeof t || (t = "undefined" == typeof i ? window.Dom7 || window.Zepto || window.jQuery : i)) && (y.$ = t, y.currentBreakpoint = void 0, y.getActiveBreakpoint = function() {
                ...
                var x, D, M, L, C, P, I, k, N, z, O = "input, select, textarea, button",
                    A = Date.now(),
                    G = [];
                ...
                function r(a, S, p) {
                    ...
                    if (k) {
                        ...
                        if (b("cancel", a, h, e)) 2 === e.state ? e.runner.end() : e.structural ? e.close() : R(a, h.options, e.options);
                            ...
                            if (2 === e.state) R(a, p, {});
                            else return S = h.event = e.event, p = R(a,
        ...
        this.$get = ["$injector", "$$AnimateRunner", "$$rAFMutex", "$$jqLite", function(b, c, d, e) {
            ...
            return function(a, b, d, e) {
                ...
                function z(a, b, d, e, g) {
                    ...
                    b.push(e);
                    if (a = a.apply(a, b))
                        if (Ca(a.start) && (a = a.start()), a instanceof c) a.done(g);
...
! function() {
    function e(e, t, n, i, o, r) {
        function a(i, a, c, s, u) {
            ...
            var T, B = C[1],
                ...
                D = angular.isDefined(_) ? parseInt(_) : y,
    ...
    function t(e, t, n) {
        ...
        return function(o) {
            ...
            var v, g, m = o.afterItemsNode,
                ...
                L = !!I.options.scrollingY,
                R = L ? k.dynamic || k.value !== I.__clientWidth : S.dynamic || S.value !== I.__clientHeight,
    ...
    a.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", "IONIC_BACK_PRIORITY", function(e, t, n, i, o, r, a, s) {
        ...
        return M.prototype.initialize = function(e) {
            ...
            register: function(e, t) {
                ...
                else if (M && M.stateId === l) z = M.viewId, q = M.historyId, O = I, M.historyId === $.historyId ? H = A : $ && (H = P, i = f(M.historyId), i && i.parentHistoryId === $.historyId ? H = V : (i = f($.historyId), i && i.parentHistoryId === d.parentHistoryId && (H = _)));
    ...
    var p = '<div class="loading-container"><div class="loading"></div></div>',
        ...
        m = "$ionicLoading instance.setContent() has been deprecated. Use $ionicLoading.show({ template: 'my content' }).";
    ...
    a.factory("$ionicPopup", ["$ionicTemplateLoader", "$ionicBackdrop", "$q", "$timeout", "$rootScope", "$ionicBody", "$compile", "$ionicPlatform", "$ionicModal", "IONIC_BACK_PRIORITY", function(e, t, n, i, o, r, a, s, l, u) {
        ...
        function() {
                    ...
                    create: function(t, s, f, T, E, L) {
                        var R, M, N, z = ++A,
                            O = {
                                ...
                                render: function(e, n) {
                                    if (N) ionic.Utils.reconnectScope(R.scope());
                                    else {
                                        p(R, x);
                                        var i = d(s, R, e.direction, f),
                                ...
                                transition: function(a, l, u) {
                                    ...
                                    var U = o.transitions.views[H.transition] || o.transitions.views.none,
                                        F = U(R, M, H.direction, H.shouldAnimate && u && L);
            ...
            B.init = function() {
                ...
                var n = B.isInitialized ? p() : h(),
                    i = B.isInitialized ? h() : null,
                    o = n.controller();
            ...
            I.scope = e, I.element = t, I.init = function() {
                ...
                var c, f, p, v, m, $, w, S, k, C = u.views.swipeBackHitWidth(),
                    T = {};
    ...
    e.$inject = ["$ionicCollectionManager", "$parse", "$window", "$$rAF", "$rootScope", "$timeout"], t.$inject = ["$rootScope", "$window", "$$rAF"], a.directive("ionContent", ["$timeout", "$controller", "$ionicBind", "$ionicConfig", function(e, t, n, i) {
        ...
        return {
            ...
            link: function(t, n, i, o) {
                ...
                var c = "large" == i.exposeAsideWhen ? "(min-width:768px)" : i.exposeAsideWhen,
                    s = e.matchMedia(c);
        ...
        return {
            ...
            compile: function(e, o) {
                function r(e, i, o) {
                    ...
                    r && (s.speedMultiplier = .8, s.bouncing = !1), t("$ionicScroll", {
                        $scope: e,
                        scrollViewOptions: s
                    })
                }
